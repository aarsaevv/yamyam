...
const getOrderedFromMenu = async () => {
...
<style scoped>
.page-container {
  background-image: url("@/assets/img/backgrounds/background-cart-1920.png");
...
@media screen and (max-width: 1540px) {
  .page-container {
    background-image: url("@/assets/img/backgrounds/background-cart-1536.png");
    background-repeat: repeat;
  }
}
